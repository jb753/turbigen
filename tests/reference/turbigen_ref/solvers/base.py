...
class BaseSolver(ABC):
    ...
    :class:`turbigen_ref.solvers.base.BaseSolver`  and implement the following
    methods:
    ...
    :class:`turbigen_ref.solvers.base.BaseSolver` is a dataclass, so has an automatic constructor and
