...
class MeanLine(ember.block.Block):
    ...
    def to_string(self):
        ...
        return turbigen_ref.util.format_table("Mean line:", self.n_row, properties)
...
class MeanLineConfig:
    ...
    def __init__(self, mean_line_type, n_row, design_vars):
        ...
        reg = turbigen_ref.plugins.get_registry()
        try:
        ...
        self.design_vars = turbigen_ref.designer.resolve_defaults(
    ...
    def valid_design_params(self):
        ...
        params = turbigen_ref.designer.design_params(self.designer)
        return {
            "required": {
                k for k, v in params.items() if v is turbigen_ref.designer.REQUIRED
            },
            "all": set(params),
        }
    ...
    def from_dict(cls, d):
        ...
        turbigen_ref.plugins.check_plugins()
    ...
    def check_nominal(self):
        ...
        turbigen_ref.designer.check_round_trip(
