...
import turbigen_ref.clusterfunc.double
...
def fixed(dmin, N, x0=0.0, x1=1.0):
    ...
    """
    return turbigen_ref.clusterfunc.double.fixed(dmin, dmin, N, x0, x1)
...
def free(dmin, dmax, ERmax, x0=0.0, x1=1.0, mult=8):
    ...
    """
    return turbigen_ref.clusterfunc.double.free(dmin, dmin, dmax, ERmax, x0, x1, mult)
