...
class BladeDesigner:
    ...
    camber_type: turbigen_ref.camber.BaseCamber = "quadratic"
    """Which method to generate the camber line."""

    thick_type: turbigen_ref.thickness.BaseThickness = "taylor"
    ...
    def __post_init__(self):
        ...
        #     turbigen_ref.nblade.BladeNumberConfig, self.number
        # )
        self.is_recambered = False

        self.camber_type = util.get_subclass_by_name(
            turbigen_ref.camber.BaseCamber, self.camber_type
        )

        self.thick_type = util.get_subclass_by_name(
            turbigen_ref.thickness.BaseThickness, self.thick_type
        )
