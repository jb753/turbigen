...
class DesignSpace:
    ...
    def __init__(
        ...
        meanline_design = turbigen_ref.util.load_mean_line(meanline_type)
...
def _case(mean_line_type, mls, Nk, k, o, varname, independent):
    mtest, mtrain = turbigen_ref.util.subsample_cases(mls, k, Nk)
    dspace = turbigen_ref.polynomial.DesignSpace(
        mean_line_type,
        mtrain,
        mtest,
        independent,
