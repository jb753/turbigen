...
subroutine smooth( &
    ...
    ! sf2n(2,:,:,:) = 2e0*sf2n(2,:,:,:)
    ! sf2n(ni-1,:,:,:) = 2e0*sf2n(ni-1,:,:,:)
    ! sf2n(:,2,:,:) = 2e0*sf2n(:,2,:,:)
    ! sf2n(:,nj-1,:,:) = 2e0*sf2n(:,nj-1,:,:)
    ! sf2n(:,:,2,:) = 2e0*sf2n(:,:,2,:)
    ! sf2n(:,:,nk-1,:) = 2e0*sf2n(:,:,nk-1,:)

    ! sf4n(2,:,:,:) = 2e0*sf4n(2,:,:,:)
    ! sf4n(ni-1,:,:,:) = 2e0*sf4n(ni-1,:,:,:)
    ! sf4n(:,2,:,:) = 2e0*sf4n(:,2,:,:)
    ! sf4n(:,nj-1,:,:) = 2e0*sf4n(:,nj-1,:,:)
    ! sf4n(:,:,2,:) = 2e0*sf4n(:,:,2,:)
    ! sf4n(:,:,nk-1,:) = 2e0*sf4n(:,:,nk-1,:)
