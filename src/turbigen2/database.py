...
:func:`~turbigen2.iterate.converge` begins wherever the file left its knobs,
...
is told rather than guessed: an :class:`~turbigen2.iterate.Iterator` declares
...
from turbigen2 import iterate, node
...
def _sample(path, wanted):
    ...
    # while `turbigen2/__init__.py` happens to import `case` before `config`.
    from turbigen2 import case
