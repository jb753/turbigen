...
import turbigen2.clusterfunc.check
import turbigen2.clusterfunc.util
import turbigen2.clusterfunc.double
...
def fixed(dmin, N, x0=0.0, x1=1.0):
    ...
    """
    return turbigen2.clusterfunc.double.fixed(dmin, dmin, N, x0, x1)
...
def free(dmin, dmax, ERmax, x0=0.0, x1=1.0, mult=8):
    ...
    """
    return turbigen2.clusterfunc.double.free(dmin, dmin, dmax, ERmax, x0, x1, mult)
