...
from turbigen2.clusterfunc.exceptions import ClusteringException
...
def _unit_fixed(dmin, dmax, ERmax, N, check=True):
    ...
    x = turbigen2.clusterfunc.util.cumsum0(dx)
    ...
    if check:
        turbigen2.clusterfunc.check.unit_single(x, dmin, dmax, ERmax)
