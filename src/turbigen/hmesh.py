...
:class:`~turbigen.machine.Machine` and wall spacings from a
:class:`~turbigen.mesh.WallSpacing` handed to it by
:meth:`~turbigen.mesh.Mesher.mesh`, rather than from an adapter object built
